 ...
 * @date   21 Jun 2019
 *
 * @brief implements an adaptor for structure_managers adding repeated entry
 * loop over the last order, e.g. with order == 2 the iteration over the
 * neighbors of atom i will contain an entry reffering to ii while before
 * only ij entries with i=/=j where considered
 *
 *
